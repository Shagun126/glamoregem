...
= Plugin Links: =
[Paid Plugin](https://berocket.com/woocommerce-grid-list-view/?utm_source=wordpress_org&utm_medium=plugin_links&utm_campaign=list_grid)
...
[Docs](https://docs.berocket.com/plugin/woocommerce-grid-list-view?utm_source=wordpress_org&utm_medium=plugin_links&utm_campaign=list_grid)


= &#127852; Wanna try admin side? =
[Admin Demo](https://berocket.com/woocommerce-grid-list-view/?utm_source=wordpress_org&utm_medium=admin_demo&utm_campaign=list_grid#try-admin) - Get access to this plugin's admin and try it from inside. Change things and watch how they work.
...
You can get more features with the premium version of Grid/List View for WooCommerce, available on [BeRocket page](https://berocket.com/woocommerce-grid-list-view/?utm_source=wordpress_org&utm_medium=faq&utm_campaign=list_grid). Here you can read more about the premium features of the plugin and make it give it its best shot!


= How can I try the full-featured plugin? =
You can try this plugin's admin side [here](https://berocket.com/woocommerce-grid-list-view/?utm_source=wordpress_org&utm_medium=faq&utm_campaign=list_grid#try-admin). Configure plugin the way you need to check the results.
...
= 1.1.3.8 =
* Enhancement - New Divi Modules for buttons
* Fix - Cookie set domain
...
* Fix - JavaScript error on list update
...
= 1.1.0.10 =
* Fix - Customizer Fatal error

= 1.1.0.9 =
* Enhancement - Compatibility version: WooCommerce 4.7
* Fix - Disable cookie set for REST API requests
...
* Enhancement - Better compatibility with Load more and AJAX Filters plugins
